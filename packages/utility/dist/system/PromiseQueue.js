System.register('PromiseQueue', [], (function (exports) {
    'use strict';
    return {
        execute: (function () {
            ...
            }; exports({ promisePool: promisePool, PromisePool: promisePool });
            ...
            }; exports({ promiseQueue: promiseQueue, PromiseQueue: promiseQueue });
